...
wave_kinetics_df_nest <- nested_df %>%
  filter(variables %in% as.character(wave_kinet_parameters)) %>% 
...
```{r results='show', include=TRUE, collapse = TRUE, fig.width=6, fig.asp = 1.6, out.width='200%'}
...
- 2. Hypothesis sting (make mix model) and export results
