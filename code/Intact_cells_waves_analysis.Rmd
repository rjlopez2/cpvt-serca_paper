...
```{r, global-options, include=FALSE, echo=FALSE, results='hide'}
...
output_result <- map(parameters, ~(sprintf(here("results",
                               "intact_cells",
                               "wave_%s"), .x)))
...
This is the head of yor dataframe after cleaning
